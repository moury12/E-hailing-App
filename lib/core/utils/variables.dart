...
List<StaticModel> staticList =[
  StaticModel(img: totalEarnIcon, title: AppStaticStrings.totalEarn, val: 'RM 600'),
  StaticModel(img: handCash1Icon, title: AppStaticStrings.handCash, val: 'RM 600'),
  StaticModel(img: coinIcon, title: AppStaticStrings.dCoin, val: 'RM 600'),
  StaticModel(img: onlineCashIcon, title: AppStaticStrings.onlineCash, val: 'RM 600'),
  StaticModel(img: tripTodayIcon, title: AppStaticStrings.tripToday, val: 'RM 600'),
  StaticModel(img: activeHourIcon, title: AppStaticStrings.activeHour, val: 'RM 600'),
  StaticModel(img: distanceTodayIcon, title: AppStaticStrings.tripDistanceToday, val: 'RM 600'),
];