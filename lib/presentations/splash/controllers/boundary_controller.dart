...
class BoundaryController extends GetxController {
  ...
  static final Map<String, CityBoundary> _cityBoundaries = {
    ...
    'kl_selangor': CityBoundary(
      ...
      rings: [
        [
          LatLng(3.055300, 101.748594),
          LatLng(3.037985, 101.725060),
          LatLng(3.041782, 101.669110),
          LatLng(3.071507, 101.647600),
          LatLng(3.120019, 101.643892),
          LatLng(3.153294, 101.615746),
          LatLng(3.196414, 101.619345),
          LatLng(3.243507, 101.661062),
          LatLng(3.214158, 101.712884),
          LatLng(3.233976, 101.730006),
          LatLng(3.190708, 101.758493),
        ],
      ],
    ),
  };
